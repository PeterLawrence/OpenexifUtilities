# Microsoft Developer Studio Generated NMAKE File, Based on WInJPEGDateCopy.dsp
!IF "$(CFG)" == ""
CFG=WInJPEGDateCopy - Win32 Debug
!MESSAGE No configuration specified. Defaulting to WInJPEGDateCopy - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "WInJPEGDateCopy - Win32 Release" && "$(CFG)" != "WInJPEGDateCopy - Win32 Debug"
...
ALL : "$(OUTDIR)\WInJPEGDateCopy.exe"
...
CLEAN :
	...
	-@erase "$(INTDIR)\WInJPEGDateCopy.obj"
	-@erase "$(INTDIR)\WInJPEGDateCopy.res"
	-@erase "$(OUTDIR)\WInJPEGDateCopy.exe"
...
RSC=rc.exe
RSC_PROJ=/l 0x809 /fo"$(INTDIR)\WInJPEGDateCopy.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\WInJPEGDateCopy.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib jpeg.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\WInJPEGDateCopy.pdb" /machine:I386 /out:"$(OUTDIR)\WInJPEGDateCopy.exe" 
LINK32_OBJS= \
	"$(INTDIR)\dlgtxtctrl.obj" \
	"$(INTDIR)\WInJPEGDateCopy.obj" \
	...
	"$(INTDIR)\WInJPEGDateCopy.res"

"$(OUTDIR)\WInJPEGDateCopy.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "$(OUTDIR)\WInJPEGDateCopy.exe" "$(OUTDIR)\WInJPEGDateCopy.bsc"
...
CLEAN :
	...
	-@erase "$(INTDIR)\WInJPEGDateCopy.obj"
	-@erase "$(INTDIR)\WInJPEGDateCopy.res"
	-@erase "$(INTDIR)\WInJPEGDateCopy.sbr"
	-@erase "$(OUTDIR)\WInJPEGDateCopy.bsc"
	-@erase "$(OUTDIR)\WInJPEGDateCopy.exe"
	-@erase "$(OUTDIR)\WInJPEGDateCopy.ilk"
	-@erase "$(OUTDIR)\WInJPEGDateCopy.pdb"
...
RSC=rc.exe
RSC_PROJ=/l 0x809 /fo"$(INTDIR)\WInJPEGDateCopy.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\WInJPEGDateCopy.bsc" 
BSC32_SBRS= \
	"$(INTDIR)\dlgtxtctrl.sbr" \
	"$(INTDIR)\WInJPEGDateCopy.sbr" \
...
"$(OUTDIR)\WInJPEGDateCopy.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<

LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib jpeg.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\WInJPEGDateCopy.pdb" /debug /machine:I386 /out:"$(OUTDIR)\WInJPEGDateCopy.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\dlgtxtctrl.obj" \
	"$(INTDIR)\WInJPEGDateCopy.obj" \
	"$(INTDIR)\ExifApp0Seg.obj" \
...
!IF EXISTS("WInJPEGDateCopy.dep")
!INCLUDE "WInJPEGDateCopy.dep"
!ELSE 
!MESSAGE Warning: cannot find "WInJPEGDateCopy.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\WInJPEGDateCopy.obj" : $(SOURCE) "$(INTDIR)"


!ELSEIF  "$(CFG)" == "WInJPEGDateCopy - Win32 Debug"


"$(INTDIR)\WInJPEGDateCopy.obj"	"$(INTDIR)\WInJPEGDateCopy.sbr" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\WInJPEGDateCopy.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
